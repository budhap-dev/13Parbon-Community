...
describe('GalleryPage', () => {
  it('lists public albums newest first with covers and counts', async () => {
    ...
    expect(screen.getByText('April 2026 · 28 photos')).toBeInTheDocument()
    expect(screen.getByText('February 2026 · 35 photos')).toBeInTheDocument()
...
describe('AlbumPage', () => {
  ...
  it('shows the album photos and opens them in the lightbox', async () => {
    ...
    expect(screen.getByRole('dialog', { name: 'Photo 2 of 28' })).toBeInTheDocument()
    await userEvent.keyboard('{ArrowLeft}')
    expect(screen.getByRole('dialog', { name: 'Photo 1 of 28' })).toBeInTheDocument()
