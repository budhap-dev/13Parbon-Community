...
describe('ArticlePage', () => {
  it('renders the article with its paragraphs and metadata', async () => {
    ...
    // The second paragraph, so the body is being split on blank lines rather than printed whole.
    expect(
      screen.getByText('The children had their hatekhori, and the photographs from the morning are in the gallery.'),
    ).toBeInTheDocument()
